...
/// Layout which splits the workspace into two columns, gives one window all of the right column,
/// and divides the left column among all the other windows.
